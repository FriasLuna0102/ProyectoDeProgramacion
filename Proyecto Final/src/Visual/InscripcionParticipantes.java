...
public class InscripcionParticipantes extends JDialog {
	...
	public InscripcionParticipantes() {
		...
		txtCodigoDeParticipante.setBounds(420, 344, 116, 22);
		...
		lblNewLabel_8.setBounds(588, 199, 133, 16);
		panel.add(lblNewLabel_8);
		
		spnEdadDeParticipantes = new JSpinner();
		spnEdadDeParticipantes.setBounds(588, 225, 121, 22);
		panel.add(spnEdadDeParticipantes);
		
		lblNewLabel_9 = new JLabel("Codigo del Evento:");
		lblNewLabel_9.setBounds(588, 267, 133, 16);
		panel.add(lblNewLabel_9);
		
		txtCodigoDelEvento = new JTextField();
		txtCodigoDelEvento.setBounds(593, 298, 116, 22);
				...
				btnRegistar.addActionListener(new ActionListener() {
					public void actionPerformed(ActionEvent e) {
							Participantes participantes = null;
								...
								participantes = new Participantes(txtNombre.getText(), txtDireccion.getText(), txtCedula.getText(), txtApellido.getText(), txtTelefono.getText(), txtCorreo.getText(), txtMatricula.getText(),txtescuelaProveniente.getText(),										
